...
@Entity
@Table(name = "ranking_electricity")
public class ElectricityEntity extends BaseEntity {
	...
	public ElectricityEntity(String monthly, CountyEntity county) {
		super();
		this.monthly = monthly;
		this.county = county;
	}

	public ElectricityEntity(String monthly, CountyEntity county, Double total, Double yearGrowth, Integer sort) {
		super();
		this.monthly = monthly;
		this.county = county;
		this.total = total;
