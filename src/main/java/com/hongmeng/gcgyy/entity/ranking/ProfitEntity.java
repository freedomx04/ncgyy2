...
public class ProfitEntity extends BaseEntity {
	...
	public ProfitEntity(String monthly, CountyEntity county) {
		super();
		this.monthly = monthly;
		this.county = county;
	}
	
	public ProfitEntity(String monthly, CountyEntity county, Double total, Double yearGrowth, Integer sort) {
		super();
		this.monthly = monthly;
		this.county = county;
		this.total = total;
