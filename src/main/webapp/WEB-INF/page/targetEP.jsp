...
<script class="template EnergyTargetEP" type="text/x-jquery-tmpl">
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}图表分析</div>
	...
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}数据详情</div>
 		<div class="am-panel-bd">
  			<table class="am-table am-table-striped am-table-hover table-main" id="energyTargetEP-table">
				<thead>
					<tr>
						<th class="table-id">#</th>
						<th>月份</th>
...
<script class="template TaxTargetEP" type="text/x-jquery-tmpl">
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}图表分析</div>
	...
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}数据详情</div>
 		<div class="am-panel-bd">
  			<table class="am-table am-table-striped am-table-hover table-main" id="taxTargetEP-table">
				<thead>
					<tr>
						<th class="table-id">#</th>
						<th>月份</th>
...
<script class="template BenefitTargetEP" type="text/x-jquery-tmpl">
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}图表分析</div>
	...
	<div class="am-panel am-panel-primary" style="margin: 0 20px 20px 20px;">
  		<div class="am-panel-hd">{{=it.title}}数据详情</div>
 		<div class="am-panel-bd">
  			<table class="am-table am-table-striped am-table-hover table-main" id="benefitTargetEP-table">
				<thead>
					<tr>
						<th class="table-id">#</th>
						<th>月份</th>
	...
	Klass.prototype = Object.create(Object.prototype, {
			...
			value: function(id) {
				...
				if (id == '0') // 总览
				{
					...
					case '1':case '2':case '3':case '4':
						...
						data = overViewData;
						$template = $(".template.EconomicTargetEP");
						table = "#economicTargetEP-table";
						chart = "#economic-chart-container";
						break;
					case '5':case '6':
						url = 'energy/listRange';
						data = overViewData;
						$template = $(".template.EnergyTargetEP");
						table = "#energyTargetEP-table";
						chart = "#energy-chart-container";
						break;
					case '7':
						url = 'nationalTax/listRange';
						data = overViewData;
						$template = $(".template.TaxTargetEP");
						table = "#taxTargetEP-table";
					...
					case '9':case '10':case '11':case '12':
						...
						data = overViewData;
						$template = $(".template.BenefitTargetEP");
						table = "#benefitTargetEP-table";
		...
		getItemTitle: {
			value: function(type) {
				var title;
				switch (type.split('-')[1]) {
				case '1':	title = subItemTitle = '工业增加值';		break;
			...
			value: function(data, $obj) {
				...
				$.each(data, function(key, val) {
					...
					if(subItem == "1") {
						...
						var electricity_yearGrowth = val.electricity_lastYear_yearGrowth != null ? (parseFloat(val.electricity_yearGrowth)*100).toFixed(2) : 0; 
						var electricity_monthGrowth = val.electricity_lastYear_monthGrowth != null ? (parseFloat(val.electricity_monthGrowth)*100).toFixed(2) : 0; 
						...
						arr1.push({y: localTax, extra: val.energy_current == null ? "-" : localTax + unit});
						...
						var receivable_yearGrowth = val.receivable_yearGrowth != null && val.receivable_yearGrowth != "" ? (parseFloat(val.receivable_yearGrowth)*100).toFixed(2) : 0;
						var receivable_monthGrowth = val.receivable_monthGrowth != null && val.receivable_monthGrowth != "" ? (parseFloat(val.receivable_monthGrowth)*100).toFixed(2) : 0;
						arr1.push({y: receivable, extra: val.benefit_current==null ? "-" : receivable + "千元"});
						arr2.push({y: parseFloat(receivable_yearGrowth), extra: val.receivable_yearGrowth==null ? "-" : receivable_yearGrowth});
						arr3.push({y: parseFloat(receivable_monthGrowth), extra: val.receivable_monthGrowth==null ? "-" : receivable_monthGrowth});
					} else if(subItem == "10") {
						text1 = "产存品存货";
						unit = "千元";
						var inventory = val.benefit_current != null ? val.benefit_current.inventory : 0;
						var inventory_yearGrowth = val.inventory_lastYear_yearGrowth != null ? (parseFloat(val.inventory_yearGrowth)*100).toFixed(2) : 0; 
						var inventory_monthGrowth = val.inventory_lastYear_monthGrowth != null ? (parseFloat(val.inventory_monthGrowth)*100).toFixed(2) : 0; 
			...
			value: function(data, $obj) {
				...
				$.each(data, function(key, val) {
					xAxisArr.push(val.monthly);
						text1 = "本月止国税";
						text2 = "本月止销售收入";
						var nationalTax = val.nationalTax_current != null ? parseFloat(val.nationalTax_current.taxes) : 0;
						...
						arr1.push({y: nationalTax, extra: val.economic_lastYear==null ? "-" : nationalTax + "元"});
						...
						var sale_yearGrowth = val.nationalTax_yearGrowth != null && val.sale_yearGrowth != "" ? (parseFloat(val.sale_yearGrowth)*100).toFixed(2) : 0;
						var sale_monthGrowth = val.nationalTax_monthGrowth != null && val.sale_monthGrowth != "" ? (parseFloat(val.sale_monthGrowth)*100).toFixed(2) : 0;
						arr4.push({y: sale, extra: val.economic_lastYear==null ? "-" : sale + "元"});
