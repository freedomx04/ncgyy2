			...
			<div class="weui_panel">
				<div class="weui_panel_bd">
					<div class="weui_media_box weui_media_text">
						<h4 class="weui_media_title">${profit.county.name}</h4>
						<table class="weui-table weui-border-tb" style="font-size: 14px; color: #999;">
							...
							<tbody>
								<tr>
									<td><fmt:formatNumber type="number" value="${profit.total}" pattern="0" maxFractionDigits="0"/></td>
									<td><fmt:formatNumber type="number" value="${profit.yearGrowth}" pattern="0.00" maxFractionDigits="2"/></td>
									<td>${profit.sort}</td>
								</tr>
							</tbody>
						</table> 
			...
			$.ajax({
				...
				success: function(ret) {
					if (ret.status == 0) {
						...
						$.each(ret.data, function(key, profit) {
